...
namespace FastHashes.Tests
{
    public static class HashTestsCases
    {
        ...
        {
            new TestCase("FarmHash32", seed => new FarmHash32(seed), "0x39AFC90D"),
            ...
            new TestCase("KomiHash", seed => new KomiHash(seed), "0xEDE8694AFBD7BD3B"),
            ...
            new TestCase("MirHash", seed => new MirHash(seed), "0xFC662A422C002E99"),
            ...
            new TestCase("Mx3Hash", seed => new Mx3Hash(seed), "0x657B287B75CBFD8B"),
            new TestCase("PengyHash", seed => new PengyHash(seed), "0xE316824706F463CE"),
            ...
            new TestCase("WyHash32", seed => new WyHash32(seed), "0x6680DE09"),
            new TestCase("WyHash64", seed => new WyHash64(seed), "0xD7BA2DA80326AF7D"),
            new TestCase("xxHash32", seed => new XxHash32(seed), "0x43B788BA"),
