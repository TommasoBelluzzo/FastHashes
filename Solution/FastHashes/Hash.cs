...
namespace FastHashes
{
    ...
    public abstract class Hash
    {
        ...
        /// <param name="buffer">The Span whose hash must be computed.</param>
        ...
        /// <returns>A <see cref="T:System.Byte"/>[] representing the computed hash.</returns>
        protected Byte[] ComputeHashInternal(Byte[] buffer, Int32 offset, Int32 count)
        {
            return ComputeHashInternal(new ReadOnlySpan<byte>(buffer, offset, count));
        }
