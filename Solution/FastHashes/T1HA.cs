...
namespace FastHashes
{
    public sealed class T1HA : Hash
    {
        ...
        #region Constructors
        public T1HA(T1HAVariant variant, UInt64 seed)
        {
            switch (variant)
            {
                case T1HAVariant.V0:
        ...
        public T1HA() : this(T1HAVariant.V2, 0ul) { }

        public T1HA(T1HAVariant variant) : this(variant, 0ul) { }

        public T1HA(UInt64 seed) : this(T1HAVariant.V2, seed) { }
        #endregion  
